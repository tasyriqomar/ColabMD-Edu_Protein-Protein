...
; GMX 2021 FIX: Group scheme and energygrp_excl are deprecated. 
; Using Verlet scheme for compatibility.
...
BASE=$i-EM
# Updated sed to remove group-based exclusions if they were somehow left in
